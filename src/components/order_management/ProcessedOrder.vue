    ...
    <scroller
      ...
      <div class="all_goods">
        <div class="goods_untread" @click="toDetail">
          ...
          <p class="order_time">申请时间：2018-06-26  14:03 <label class="goods_status">待收货</label></p>
        ...
        <div class="goods_untread" @click="toDetail">
          <div class="null_grey"></div>
          <p class="order_time">申请时间：2018-06-26  14:03 <label class="goods_status">已完成</label></p>
          <div class="goods_detail">
            <img class="goods_img" src="../../../static/img/demo.jpg" alt="">
            <div class="word_detail">
              <p>新鲜水果包邮新鲜水果包邮新鲜水果包邮新鲜水果包邮新鲜水果包邮</p>
